...
<footer class="footer">
  <div class="container-fluid">
    ...
    <div class="copyright float-right">
      ...
      <a href="https://www.newagesmb.com" target="_blank">ZohoTestDesk</a> All rights reserved. 
          <span style="color: #999999; font-size: 12px; line-height: 22px;"> Version 0.1</span>
    </div>
  </div>
</footer>
<!--   Core JS Files   -->
...
<script src="<?php echo base_url() ; ?>/template/assets/js/material-dashboard.js?v=2.1.2" type="text/javascript">
</script>
